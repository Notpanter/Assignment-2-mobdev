...
class DogCardAdapter(
    ...
    class DogCardViewHolder(view: View?): RecyclerView.ViewHolder(view!!) {
        ...
        val hobby: TextView = view!!.findViewById(R.id.hobby)
    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DogCardViewHolder {
        ...
        return when(layout){
            ...
            Layout.GRID -> {
                val lay = LayoutInflater.from(parent.context).inflate(R.layout.vertical_horizontal_list_item, parent, false)
                DogCardViewHolder(lay)
            } else ->{
                val lay = LayoutInflater.from(parent.context).inflate(R.layout.vertical_horizontal_list_item, parent, false)
                DogCardViewHolder(lay)
            }
